...
SELECT
    ...
    SUM(CASE WHEN is_active_credit THEN 1 ELSE 0 END) AS active_loans,
    SUM(CASE WHEN is_bad_debt THEN 1 ELSE 0 END) AS bad_debt_loans,
    ...
    SUM(CASE WHEN recent_credit_flag THEN 1 ELSE 0 END) AS recent_credit_count
FROM silver.bureau
GROUP BY sk_id_curr;
